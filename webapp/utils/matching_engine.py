...
class MatchingEngine(VectorStore):
    ...
    def __init__(
        ...
        gcs_bucket_name: str,
        #credentials: Credentials = os.environ["GOOGLE_APPLICATION_CREDENTIALS"],
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        for idx, (embedding, text, metadata) in enumerate(
            ...
            id = uuid.uuid4()
            ids.append(id)
            print(f"Uploading text: {text} \n to GCS bucket: {self.gcs_bucket_name} \n with id argument: documents/{id}")
    ...
    def _upload_to_gcs(self, data: str, gcs_location: str) -> None:
        ...
        """
        print(f"Uploading to GCS bucket: {self.gcs_bucket_name} \n with location argument: {gcs_location}")
